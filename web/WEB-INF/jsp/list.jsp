...
<section>
    ...
    <table border="1" cellpadding="8" cellspacing="0" style="margin: auto">
        <tr>
            <th><a href="resume?action=add"><img src="img/add.png" alt="add.png"> Новое резюме</a></th>
        </tr>
    </table>
    <br>
    <table border="1" cellpadding="8" cellspacing="0" style="margin: auto">
        ...
        <c:forEach items="${resumes}" var="resume">
            ...
            <tr>
                ...
                <td align="center"><a href="resume?uuid=${resume.uuid}&action=edit"><img src="img/pencil.png"
                                                                                         alt="pencil.png"></a></td>
            </tr>
        </c:forEach>
    </table>
